...
def main():
    ...
    for backbone_name in backbones:
        ...
        # Use train/test split directories
        ...
        if os.path.isdir(train_dir) and os.path.isdir(test_dir):
            ...
            print(f"  Train: {len(train_ds)}, Test: {len(test_ds)}, Breeds: {len(breed_names)}")
        else:
            # Fallback: use Images directory
            train_loader, test_loader, breed_names = get_dataloaders(
                data_dir, preprocess_config, batch_size=args.batch_size,
            )
